...
public:
/*  explicit BoostedJetONNXTritonJetTagsProducer(const edm::ParameterSet & cfg) : SonicEDProducer<TritonClient>(cfg) {
    //for debugging
  ...
  */
  explicit BoostedJetONNXTritonJetTagsProducer(const edm::ParameterSet & cfg) ;
...
BoostedJetONNXTritonJetTagsProducer::BoostedJetONNXTritonJetTagsProducer(const edm::ParameterSet &iConfig)
    : SonicEDProducer<TritonClient>(iConfig),
...
BoostedJetONNXTritonJetTagsProducer::~BoostedJetONNXTritonJetTagsProducer() {}

void BoostedJetONNXTritonJetTagsProducer::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
...
std::unique_ptr<ONNXRuntime> BoostedJetONNXTritonJetTagsProducer::initializeGlobalCache(const edm::ParameterSet &iConfig) {
  return std::make_unique<ONNXRuntime>(iConfig.getParameter<edm::FileInPath>("model_path").fullPath());
}

void BoostedJetONNXTritonJetTagsProducer::globalEndJob(const ONNXRuntime *cache) {}

void BoostedJetONNXTritonJetTagsProducer::acquire(edm::Event const&iEvent, const edm::EventSetup &iSetup, SonicEDProducer<TritonClient>::Input& iInput) {
...
std::vector<float> BoostedJetONNXTritonJetTagsProducer::center_norm_pad(const std::vector<float> &input,
                                                                  float center,
                                                                  float norm_factor,
                                                                  unsigned min_length,
                                                                  unsigned max_length,
...
void BoostedJetONNXTritonJetTagsProducer::make_inputs(const reco::DeepBoostedJetTagInfo &taginfo) {
...
DEFINE_FWK_MODULE(BoostedJetONNXTritonJetTagsProducer);
